...
export const Header = () => {
  ...
  return (
    <>
        ...
        <div className="shop-container mx-auto px-4">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-1.5">
            <div className="flex items-center gap-2">
              ...
              <p className="text-[10px] md:text-xs tracking-wide text-gray-600">Welcome to ShopHub - Premium Quality Products</p>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1">
                <Truck size={11} className="text-gray-400" />
                <span className="text-[10px] hidden md:inline text-gray-600">Free Shipping on Orders $50+</span>
              </div>
        ...
        <div className="shop-container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-1.5">
            <div className="flex items-center gap-2">
              ...
              <p className="text-[11px] text-gray-600">✨ Free Express Shipping on orders over $50</p>
            </div>
            <div className="flex items-center gap-1">
              <ButtonPrimary
                title="My Account"
      ...
      {/* Main Header - White with Logo, Search, and Cart */}
      <div className="main-header bg-white shadow-sm sticky top-0 z-40 border-b border-gray-200">
        <div className="shop-container mx-auto px-4 py-3">
          <div className="flex items-center justify-between gap-4">
            {/* Logo */}
            <Link href="/" className="flex items-center gap-2 group shrink-0">
              <div className="relative">
                <Image src={LogoImage} alt="Logo" height={38} className="object-contain" />
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:flex items-center gap-2 group cursor-pointer">
                ...
                <div>
                  <div className="uppercase text-[9px] font-semibold text-gray-400 tracking-wider">Call Us Now</div>
                  <div className="font-semibold text-xs text-gray-700">+880 1307 692679</div>
                </div>
              </div>

              {/* Shopping Cart */}
              <div className="flex items-center gap-2 group cursor-pointer relative">
                <div className="p-1.5 bg-gray-100 rounded-lg group-hover:bg-gray-200 transition-all duration-300 relative">
                  <ShoppingCart size={20} color="#6B7280" strokeWidth={1.5} />
                  <span className="absolute -top-1 -right-1 bg-gray-700 text-white text-[9px] font-bold rounded-full w-3.5 h-3.5 flex items-center justify-center shadow-sm">
                    0
                  </span>
                </div>
                <div className="hidden md:block">
                  <div className="uppercase text-[9px] font-semibold text-gray-400 tracking-wider">Cart</div>
