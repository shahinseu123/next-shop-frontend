...
export const ProductDataTable = () => {
    ...
    const headers: DataTableHeader[] = [
      ...
      const context: ApiContext = { url: "/api/v1/products", method: "GET" };
      ...
      const handleEdit = (row: any) => {
       ...
       const deleteProduct = async (id: number) => {
        await executeDelete({url :`/api/v1/products/delete/${id}`});
        setRefreshKey(prev => prev + 1);
      };
    
      const handleCreate = () => {
         router.push("/application/shop/admin/products/new")
      }
